...
> = {
  ...
  mongodb: {
    fields: [
      ...
      {
        name: "database",
        label: "Database to sync",
        type: "text",
        placeholder: "production_db",
        required: true,
        description: "Populates database_includes",
      },
      {
        name: "tls",
        label: "Enable TLS",
      ...
      },
      {
        ...
        type: "select",
        required: false,
        description: "Infer (recommended) for typed columns",
        options: [
      ...
      {
        name: "mongo_infer_sample_size",
        label: "Sample size for schema inference",
        type: "number",
        placeholder: "2000",
        required: false,
      },
