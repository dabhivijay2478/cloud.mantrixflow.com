...
export const MOCK_PIPELINE = {
  ...
  builder_view_mode: "table" as const,
  ...
  pipeline_graph: {
    nodes: [
      ...
      },
      {
        ...
        data: {
          connection_id: "conn-dest-003",
          connector_type: "snowflake",
          connection_name: "Snowflake Warehouse",
          host_summary: "acme_wh / analytics_db",
          dest_schema: "public",
          dest_table: "orders_sync",
          emit_method: "append",
          is_active: true,
        },
      },
    ...
    branches: [
      ...
      },
      {
        ...
        transform_node_id: "transform-3",
        destination_node_id: "destination-3",
      },
    ],
  },
};
